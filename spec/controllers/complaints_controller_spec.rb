...
RSpec.describe ComplaintsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      complaint = Complaint.create! valid_attributes
      get :edit, params: {id: complaint.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Complaint" do
        expect {
          post :create, params: {complaint: valid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested complaint" do
        complaint = Complaint.create! valid_attributes
        put :update, params: {id: complaint.to_param, complaint: new_attributes}, session: valid_session
        complaint.reload
      ...
      it "redirects to the complaint" do
        complaint = Complaint.create! valid_attributes
        put :update, params: {id: complaint.to_param, complaint: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        complaint = Complaint.create! valid_attributes
        put :update, params: {id: complaint.to_param, complaint: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested complaint" do
      complaint = Complaint.create! valid_attributes
      expect {
        delete :destroy, params: {id: complaint.to_param}, session: valid_session
      }.to change(Complaint, :count).by(-1)
    end
